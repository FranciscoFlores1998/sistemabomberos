...
export function AgregarMovilesVoluntarios({ folioPAsistencia, onSubmitStep2 }: Props) {
    ...
    <div className="mt-8">
      <div className="flex flex-col space-y-4 mt-6">
        ...
        <div className="flex space-x-2">
          ...
          />
          <Button onClick={() => {
            const movilValue = control._getWatch('movil');
            if (movilValue) handleAddMovil(movilValue);
      ...
      <div className="flex flex-col space-y-4 mt-6">
        ...
        <div className="flex space-x-2">
          ...
          />
          <Button onClick={() => {
            const voluntarioValue = control._getWatch('voluntario');
